...
from wfb.notifications.utils import id2slug
...
EXTRA_DATA = settings.NOTIFICATONS_CONFIG["USE_JSONFIELD"]


def is_soft_delete():
    return settings.NOTIFICATONS_CONFIG["SOFT_DELETE"]
...
class AbstractNotification(models.Model):
    ...
    level = models.CharField(
        _("level"), choices=Levels.choices, default=Levels.INFO, max_length=20
    )
    ...
    class Meta:
        ...
        # index_together = ("recipient", "unread") # Django 4.2 deprecated this
        indexes = [
...
class Notification(AbstractNotification):
    class Type(models.TextChoices):
        MISC = "MISC", _("MISC")
        JOB_INVITATION = "JOB INVITATION", _("JOB INVITATION")
        JOB_APPLICATION = "JOB APPLICATION", _("JOB APPLICATION")

    _type = models.CharField(choices=Type.choices, max_length=24, default=Type.MISC)
